...
{
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"AnnounceCell" forIndexPath:indexPath];
    
//    NSDictionary announcements = [self.announcements];
    NSString *title = [_announcements[indexPath.row] valueForKeyPath:@"title"];
    NSString *body = [_announcements[indexPath.row] valueForKeyPath:@"body"];
    
    // quick and dirt html strip function taken from http://stackoverflow.com/questions/277055/remove-html-tags-from-an-nsstring-on-the-iphone
    NSRange r;
    NSString *s = [body copy];
